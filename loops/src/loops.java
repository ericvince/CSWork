public class loops {
    ...
    public static void writeSquares() {
        ...
        // This can be done easier with loops
        writeSquares2();
    }
    ...
    public static void writeSquares2() {
        ...
        // The middle part is the condition which will
        ...
        // For the next loop, we will continue as long
        // as i is less than or equal to 100
        writeSquares3();
    }

    public static void writeSquares3() {
        System.out.println("writeSquare3...");
        for (int i = 1; i <= 100; i++) {
            System.out.println(i + " squared = " + (i * i));
        }
        // Lets make the next on a little more interesting
    ...
    public static void writeSquares5()
    {
        ...
        // it goes from 4 to 51 for a total
        // of 47 loops
        // You also don't need to count by 1s
        //writeSquares6();
    }
}